            ...
            <div className="relative z-10 w-full max-w-110">
                    ...
                    <div className="card-body p-10 sm:p-12">
                        ...
                        <div className="flex flex-col items-center text-center mb-10">
                            ...
                            <h1 className="text-3xl font-black text-white tracking-tight mb-2">
                                Tambah <span className="text-white bg-clip-text bg-linear-to-r from-blue-400 to-indigo-400">Admin</span>
                            </h1>
                            <p className="text-slate-400 font-medium">Buat akun admin baru untuk sistem</p>
                        </div>
                            ...
                            <div className="form-control">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="input w-full bg-white/3 border-white/10 focus:border-blue-500 focus:bg-white/6 text-white pl-12 h-14 rounded-2xl transition-all duration-300 placeholder:text-slate-500"
                                        required
                                    />
                                </div>
                            </div>
                ...
                <div className="mt-8 text-center">
                    <p className="text-white text-sm font-medium opacity-80">
                        Pabrik Roti Bread Gift &bull; Admin Management
                    </p>
                </div>
            </div>
        </main>
